        ...
        <li key={card.date} className="timeline__item card">
          <div className="timeline__head">
            ...
            <span className="timeline__week">
              Week {card.gestationalWeek} + {card.gestationalDay}d
            </span>
          </div>
          ...
          <div className="timeline__meta">
            {card.sizeLabel && <span className="chip">size: {card.sizeLabel}</span>}
            {card.mood && <span className="chip">mood: {card.mood}</span>}
          </div>
        </li>
      ))}
    </ol>
